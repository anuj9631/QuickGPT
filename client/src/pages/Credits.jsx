          ...
          >
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-300 mb-4">
                ${plan.price}
                 <span className="text-base font-normal text-gray-600 dark:text-purple-200"> {' '}/{plan.credits} credits
              </span>
              </p>
            ...
            <button className="mt-6 bg-purple-600 hover:bg-purple-700 actice:bg-purple-800 text-white font-medium py-2 rounded transition-colors cursor-pointer">Buy Now</button>
          </div>
        ))}
      </div>
    </div>
